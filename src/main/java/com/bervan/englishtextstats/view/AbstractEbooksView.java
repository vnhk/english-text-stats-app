...
public abstract class AbstractEbooksView extends AbstractBervanTableView<UUID, ExtractedEbookText> {
    ...
    public AbstractEbooksView(ExtractedEbookTextService service, BervanViewConfig bervanViewConfig) {
        super(new EnglishTextLayout(ROUTE_NAME), service, bervanViewConfig, ExtractedEbookText.class);
