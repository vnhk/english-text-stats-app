...
public abstract class AbstractNotLearnedWordsBaseView extends AbstractBervanTableView<UUID, Word> {
    ...
    public AbstractNotLearnedWordsBaseView(WordService service, MenuNavigationComponent layout, AddAsFlashcardService addAsFlashcardService, String language, BervanViewConfig bervanViewConfig) {
        super(layout, service, bervanViewConfig, Word.class);
    ...
    protected void buildOnColumnClickDialogContent(Dialog dialog, VerticalLayout dialogLayout, HorizontalLayout headerLayout, String clickedField, Word item) {
        ...
        addAsFlashcard.addClickListener(e -> {
            ...
            addAsFlashcardService.addAsFlashcardAsync(item, language);
            dialog.close();
            clickOnFirstRow();
        });
